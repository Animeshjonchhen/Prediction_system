import math
#importing machine learning codes
import pandas as pd
...
def appointment_result(request):
    ...
    send_mail(
        ...
        email_message,
        your_email,
        ['ghosthunter5470@gmail.com','surajkoju22@gmail.com','sabinprajapati7@gmail.com','animeshjonchhen123@gmail.com']
    )
